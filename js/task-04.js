...
const removeClick = decrementEl.addEventListener('click', onReduceValueButtonClick);

const addClick = incrementEl.addEventListener('click', onGrowValueButtonClick);

function onReduceValueButtonClick() {
  return counterValue.textContent -= 1
};

function onGrowValueButtonClick() {
